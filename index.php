      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/konark.jpg" class="d-block w-100 img-fluid"  alt="...">
            <div class="carousel-caption d-none d-md-block external-img">
              <h5>Bank Of Odisha</h5>
              <p>A Safe place for your money.</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="https://www.slideteam.net/media/catalog/product/cache/1280x720/b/a/banking_powerpoint_presentation_slides_Slide01.jpg" class="d-block w-100 img-fluid" alt="...">
            <div class="carousel-caption d-none d-md-block external-img">
      ...
      <!-- CArosoul part end -->
        ...
        <div class="container my-5">
            ...
            <div class="row row-cols-2">       
              ...
              <div class="col">
              <img src="https://d24uab5gycr2uz.cloudfront.net/uploads/other_pic/VVZIVXymJG.png" class="rounded img-fluid float-right" alt="...">
              </div>
            </div>
            </section>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 " >
            <p>
            Bank of Odisha is a leading financial institution dedicated to providing exceptional banking services to the people of Odisha, a vibrant state in eastern India. Established in 1965, the bank has been a trusted partner for individuals, businesses, and communities, offering a wide range of banking products and services to cater to their diverse financial needs.
            </p>
